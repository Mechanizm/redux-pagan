...
var i18nResolver = (0, _lodash2.default)(function i18nResolver(locale, data, version) {
...
function getLang(i18n) {
  ...
  return i18nResolver.apply(undefined, [i18n.locale, i18n.data[i18n.locale], i18n.__version__].concat(args));
}